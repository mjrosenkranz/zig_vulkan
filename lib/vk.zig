...
pub const VK_PIPELINE_STAGE_FLAG_BITS_2KHR_MAX_ENUM_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 9223372036854775807)));
...
pub const VK_ACCESS_FLAG_BITS_2KHR_MAX_ENUM_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 9223372036854775807)));
...
pub const VkAabbPositionsNV = VkAabbPositionsKHR; // /usr/include/vulkan/vulkan_core.h:9876:35: warning: struct demoted to opaque type - has bitfield
...
pub const offsetof = @compileError("TODO implement function '__builtin_offsetof' in std.c.builtins"); // /home/xenone/zig/lib/include/stddef.h:104:9
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/xenone/zig/lib/include/stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token .HashHash"); // /home/xenone/zig/lib/include/stdint.h:282:9
pub const __uint_c = @compileError("unable to translate C expr: expected ',' or ')'"); // /home/xenone/zig/lib/include/stdint.h:284:9
...
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /usr/include/vulkan/vulkan_core.h:39:17
pub const __llvm__ = @as(c_int, 1);
pub const __clang__ = @as(c_int, 1);
pub const __clang_major__ = @as(c_int, 12);
pub const __clang_minor__ = @as(c_int, 0);
pub const __clang_patchlevel__ = @as(c_int, 0);
pub const __clang_version__ = "12.0.0 (git@github.com:ziglang/zig-bootstrap.git fc78f1770c0bccc5262577456da4172ae36abbc2)";
...
pub const __VERSION__ = "Clang 12.0.0 (git@github.com:ziglang/zig-bootstrap.git fc78f1770c0bccc5262577456da4172ae36abbc2)";
...
pub fn VK_MAKE_VERSION(major: anytype, minor: anytype, patch: anytype) callconv(.Inline) @TypeOf(((@import("std").meta.cast(u32, major) << @as(c_int, 22)) | (@import("std").meta.cast(u32, minor) << @as(c_int, 12))) | @import("std").meta.cast(u32, patch)) {
...
pub const VK_API_VERSION_1_0 = VK_MAKE_VERSION(@as(c_int, 1), @as(c_int, 0), @as(c_int, 0));
pub const VK_HEADER_VERSION = @as(c_int, 174);
pub const VK_HEADER_VERSION_COMPLETE = VK_MAKE_VERSION(@as(c_int, 1), @as(c_int, 2), VK_HEADER_VERSION);
pub fn VK_VERSION_MAJOR(version: anytype) callconv(.Inline) @TypeOf(@import("std").meta.cast(u32, version) >> @as(c_int, 22)) {
    return @import("std").meta.cast(u32, version) >> @as(c_int, 22);
}
pub fn VK_VERSION_MINOR(version: anytype) callconv(.Inline) @TypeOf((@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF)) {
    return (@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF);
}
pub fn VK_VERSION_PATCH(version: anytype) callconv(.Inline) @TypeOf(@import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF)) {
    return @import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF);
}
pub const VK_ATTACHMENT_UNUSED = ~@as(c_uint, 0);
pub const VK_FALSE = @as(c_int, 0);
...
pub const VK_TRUE = @as(c_int, 1);
pub const VK_WHOLE_SIZE = ~@as(c_ulonglong, 0);
pub const VK_MAX_MEMORY_TYPES = @as(c_int, 32);
pub const VK_MAX_MEMORY_HEAPS = @as(c_int, 16);
pub const VK_MAX_PHYSICAL_DEVICE_NAME_SIZE = @as(c_int, 256);
pub const VK_UUID_SIZE = @as(c_int, 16);
pub const VK_MAX_EXTENSION_NAME_SIZE = @as(c_int, 256);
pub const VK_MAX_DESCRIPTION_SIZE = @as(c_int, 256);
pub const VK_VERSION_1_1 = @as(c_int, 1);
pub const VK_API_VERSION_1_1 = VK_MAKE_VERSION(@as(c_int, 1), @as(c_int, 1), @as(c_int, 0));
pub const VK_MAX_DEVICE_GROUP_SIZE = @as(c_int, 32);
pub const VK_LUID_SIZE = @as(c_int, 8);
pub const VK_QUEUE_FAMILY_EXTERNAL = ~@as(c_uint, 1);
pub const VK_VERSION_1_2 = @as(c_int, 1);
pub const VK_API_VERSION_1_2 = VK_MAKE_VERSION(@as(c_int, 1), @as(c_int, 2), @as(c_int, 0));
pub const VK_MAX_DRIVER_NAME_SIZE = @as(c_int, 256);
pub const VK_MAX_DRIVER_INFO_SIZE = @as(c_int, 256);
...
pub const VK_KHR_INCREMENTAL_PRESENT_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_EXT_DEBUG_REPORT_SPEC_VERSION = @as(c_int, 9);
...
pub const VK_EXT_CALIBRATED_TIMESTAMPS_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_QCOM_RENDER_PASS_TRANSFORM_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_QCOM_ROTATED_COPY_COMMANDS_SPEC_VERSION = @as(c_int, 0);
