...
pub const VK_STRUCTURE_TYPE_CU_MODULE_CREATE_INFO_NVX = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_CU_MODULE_CREATE_INFO_NVX);
pub const VK_STRUCTURE_TYPE_CU_FUNCTION_CREATE_INFO_NVX = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_CU_FUNCTION_CREATE_INFO_NVX);
pub const VK_STRUCTURE_TYPE_CU_LAUNCH_INFO_NVX = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_CU_LAUNCH_INFO_NVX);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_PROVOKING_VERTEX_STATE_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_PROVOKING_VERTEX_STATE_CREATE_INFO_EXT);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INHERITED_VIEWPORT_SCISSOR_FEATURES_NV);
pub const VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV);
...
pub const VK_STRUCTURE_TYPE_MEMORY_BARRIER_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MEMORY_BARRIER_2_KHR);
pub const VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2_KHR);
pub const VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2_KHR);
pub const VK_STRUCTURE_TYPE_DEPENDENCY_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_DEPENDENCY_INFO_KHR);
pub const VK_STRUCTURE_TYPE_SUBMIT_INFO_2_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SUBMIT_INFO_2_KHR);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO_KHR);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES_KHR);
pub const VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV);
pub const VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_CHECKPOINT_DATA_2_NV);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_2_PLANE_444_FORMATS_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_2_PLANE_444_FORMATS_FEATURES_EXT);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_FEATURES_KHR = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_FEATURES_KHR);
...
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE);
pub const VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT);
pub const VK_STRUCTURE_TYPE_VERTEX_INPUT_ATTRIBUTE_DESCRIPTION_2_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_VERTEX_INPUT_ATTRIBUTE_DESCRIPTION_2_EXT);
pub const VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA);
pub const VK_STRUCTURE_TYPE_MEMORY_ZIRCON_HANDLE_PROPERTIES_FUCHSIA = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MEMORY_ZIRCON_HANDLE_PROPERTIES_FUCHSIA);
pub const VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA);
pub const VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_ZIRCON_HANDLE_INFO_FUCHSIA = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_ZIRCON_HANDLE_INFO_FUCHSIA);
pub const VK_STRUCTURE_TYPE_SEMAPHORE_GET_ZIRCON_HANDLE_INFO_FUCHSIA = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SEMAPHORE_GET_ZIRCON_HANDLE_INFO_FUCHSIA);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_SCREEN_SURFACE_CREATE_INFO_QNX = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_SCREEN_SURFACE_CREATE_INFO_QNX);
pub const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT);
pub const VK_STRUCTURE_TYPE_PIPELINE_COLOR_WRITE_CREATE_INFO_EXT = @enumToInt(enum_VkStructureType.VK_STRUCTURE_TYPE_PIPELINE_COLOR_WRITE_CREATE_INFO_EXT);
...
pub const VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR);
pub const VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR = @enumToInt(enum_VkImageLayout.VK_IMAGE_LAYOUT_ATTACHMENT_OPTIMAL_KHR);
...
pub const VK_OBJECT_TYPE_CU_MODULE_NVX = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_CU_MODULE_NVX);
pub const VK_OBJECT_TYPE_CU_FUNCTION_NVX = @enumToInt(enum_VkObjectType.VK_OBJECT_TYPE_CU_FUNCTION_NVX);
...
pub const VK_VENDOR_ID_POCL = @enumToInt(enum_VkVendorId.VK_VENDOR_ID_POCL);
...
pub const VK_FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT);
pub const VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT);
pub const VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT);
pub const VK_FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT = @enumToInt(enum_VkFormat.VK_FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT);
...
pub const VK_DYNAMIC_STATE_VERTEX_INPUT_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_VERTEX_INPUT_EXT);
pub const VK_DYNAMIC_STATE_PATCH_CONTROL_POINTS_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_PATCH_CONTROL_POINTS_EXT);
pub const VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_DEPTH_BIAS_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_LOGIC_OP_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_LOGIC_OP_EXT);
pub const VK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_PRIMITIVE_RESTART_ENABLE_EXT);
pub const VK_DYNAMIC_STATE_COLOR_WRITE_ENABLE_EXT = @enumToInt(enum_VkDynamicState.VK_DYNAMIC_STATE_COLOR_WRITE_ENABLE_EXT);
...
pub const VK_DESCRIPTOR_TYPE_MUTABLE_VALVE = @enumToInt(enum_VkDescriptorType.VK_DESCRIPTOR_TYPE_MUTABLE_VALVE);
...
pub const VK_ACCESS_NONE_KHR = @enumToInt(enum_VkAccessFlagBits.VK_ACCESS_NONE_KHR);
...
pub const VK_PIPELINE_STAGE_NONE_KHR = @enumToInt(enum_VkPipelineStageFlagBits.VK_PIPELINE_STAGE_NONE_KHR);
...
pub const enum_VkEventCreateFlagBits = extern enum(c_int) {
    VK_EVENT_CREATE_DEVICE_ONLY_BIT_KHR = 1,
    VK_EVENT_CREATE_FLAG_BITS_MAX_ENUM = 2147483647,
    _,
};
pub const VK_EVENT_CREATE_DEVICE_ONLY_BIT_KHR = @enumToInt(enum_VkEventCreateFlagBits.VK_EVENT_CREATE_DEVICE_ONLY_BIT_KHR);
pub const VK_EVENT_CREATE_FLAG_BITS_MAX_ENUM = @enumToInt(enum_VkEventCreateFlagBits.VK_EVENT_CREATE_FLAG_BITS_MAX_ENUM);
...
pub const VK_DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_VALVE = @enumToInt(enum_VkDescriptorPoolCreateFlagBits.VK_DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_VALVE);
...
pub const VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_VALVE = @enumToInt(enum_VkDescriptorSetLayoutCreateFlagBits.VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_VALVE);
...
pub const VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA = @enumToInt(enum_VkExternalMemoryHandleTypeFlagBits.VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA);
...
pub const VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_ZIRCON_EVENT_BIT_FUCHSIA = @enumToInt(enum_VkExternalSemaphoreHandleTypeFlagBits.VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_ZIRCON_EVENT_BIT_FUCHSIA);
...
pub const VK_DRIVER_ID_COREAVI_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_COREAVI_PROPRIETARY);
pub const VK_DRIVER_ID_JUICE_PROPRIETARY = @enumToInt(enum_VkDriverId.VK_DRIVER_ID_JUICE_PROPRIETARY);
...
pub const VK_PIPELINE_STAGE_2_EARLY_FRAGMENT_TESTS_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 256)));
pub const VK_PIPELINE_STAGE_2_LATE_FRAGMENT_TESTS_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 512)));
pub const VK_PIPELINE_STAGE_2_COLOR_ATTACHMENT_OUTPUT_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 1024)));
pub const VK_PIPELINE_STAGE_2_COMPUTE_SHADER_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 2048)));
pub const VK_PIPELINE_STAGE_2_ALL_TRANSFER_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4096)));
pub const VK_PIPELINE_STAGE_2_TRANSFER_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_long, @as(c_int, 4096)));
pub const VK_PIPELINE_STAGE_2_BOTTOM_OF_PIPE_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8192)));
pub const VK_PIPELINE_STAGE_2_HOST_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 16384)));
pub const VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 32768)));
pub const VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 65536)));
pub const VK_PIPELINE_STAGE_2_COPY_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4294967296)));
pub const VK_PIPELINE_STAGE_2_RESOLVE_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8589934592)));
pub const VK_PIPELINE_STAGE_2_BLIT_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 17179869184)));
pub const VK_PIPELINE_STAGE_2_CLEAR_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 34359738368)));
pub const VK_PIPELINE_STAGE_2_INDEX_INPUT_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 68719476736)));
pub const VK_PIPELINE_STAGE_2_VERTEX_ATTRIBUTE_INPUT_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 137438953472)));
pub const VK_PIPELINE_STAGE_2_PRE_RASTERIZATION_SHADERS_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 274877906944)));
pub const VK_PIPELINE_STAGE_2_TRANSFORM_FEEDBACK_BIT_EXT: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 16777216)));
pub const VK_PIPELINE_STAGE_2_CONDITIONAL_RENDERING_BIT_EXT: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 262144)));
pub const VK_PIPELINE_STAGE_2_COMMAND_PREPROCESS_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 131072)));
pub const VK_PIPELINE_STAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4194304)));
pub const VK_PIPELINE_STAGE_2_SHADING_RATE_IMAGE_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_long, @as(c_int, 4194304)));
pub const VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 33554432)));
pub const VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 2097152)));
pub const VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_long, @as(c_int, 2097152)));
pub const VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @as(c_long, @as(c_int, 33554432)));
pub const VK_PIPELINE_STAGE_2_FRAGMENT_DENSITY_PROCESS_BIT_EXT: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8388608)));
pub const VK_PIPELINE_STAGE_2_TASK_SHADER_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 524288)));
pub const VK_PIPELINE_STAGE_2_MESH_SHADER_BIT_NV: VkPipelineStageFlagBits2KHR = @bitCast(VkPipelineStageFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 1048576)));
...
pub const VK_ACCESS_2_COLOR_ATTACHMENT_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 256)));
pub const VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 512)));
pub const VK_ACCESS_2_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 1024)));
pub const VK_ACCESS_2_TRANSFER_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 2048)));
pub const VK_ACCESS_2_TRANSFER_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4096)));
pub const VK_ACCESS_2_HOST_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8192)));
pub const VK_ACCESS_2_HOST_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 16384)));
pub const VK_ACCESS_2_MEMORY_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 32768)));
pub const VK_ACCESS_2_MEMORY_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 65536)));
pub const VK_ACCESS_2_SHADER_SAMPLED_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4294967296)));
pub const VK_ACCESS_2_SHADER_STORAGE_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8589934592)));
pub const VK_ACCESS_2_SHADER_STORAGE_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 17179869184)));
pub const VK_ACCESS_2_TRANSFORM_FEEDBACK_WRITE_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 33554432)));
pub const VK_ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 67108864)));
pub const VK_ACCESS_2_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 134217728)));
pub const VK_ACCESS_2_CONDITIONAL_RENDERING_READ_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 1048576)));
pub const VK_ACCESS_2_COMMAND_PREPROCESS_READ_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 131072)));
pub const VK_ACCESS_2_COMMAND_PREPROCESS_WRITE_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 262144)));
pub const VK_ACCESS_2_FRAGMENT_SHADING_RATE_ATTACHMENT_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 8388608)));
pub const VK_ACCESS_2_SHADING_RATE_IMAGE_READ_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_long, @as(c_int, 8388608)));
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 2097152)));
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_KHR: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 4194304)));
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_long, @as(c_int, 2097152)));
pub const VK_ACCESS_2_ACCELERATION_STRUCTURE_WRITE_BIT_NV: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @as(c_long, @as(c_int, 4194304)));
pub const VK_ACCESS_2_FRAGMENT_DENSITY_MAP_READ_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 16777216)));
pub const VK_ACCESS_2_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT: VkAccessFlagBits2KHR = @bitCast(VkAccessFlagBits2KHR, @truncate(c_ulong, @as(c_ulonglong, 524288)));
pub const enum_VkSubmitFlagBitsKHR = extern enum(c_int) {
    VK_SUBMIT_PROTECTED_BIT_KHR = 1,
    VK_SUBMIT_FLAG_BITS_MAX_ENUM_KHR = 2147483647,
    _,
};
pub const VK_SUBMIT_PROTECTED_BIT_KHR = @enumToInt(enum_VkSubmitFlagBitsKHR.VK_SUBMIT_PROTECTED_BIT_KHR);
pub const VK_SUBMIT_FLAG_BITS_MAX_ENUM_KHR = @enumToInt(enum_VkSubmitFlagBitsKHR.VK_SUBMIT_FLAG_BITS_MAX_ENUM_KHR);
...
pub const struct_VkPhysicalDeviceSynchronization2FeaturesKHR = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    synchronization2: VkBool32,
};
pub const VkPhysicalDeviceSynchronization2FeaturesKHR = struct_VkPhysicalDeviceSynchronization2FeaturesKHR;
...
pub const PFN_vkCmdWriteBufferMarker2AMD = ?fn (VkCommandBuffer, VkPipelineStageFlags2KHR, VkBuffer, VkDeviceSize, u32) callconv(.C) void;
...
pub extern fn vkCmdWriteBufferMarker2AMD(commandBuffer: VkCommandBuffer, stage: VkPipelineStageFlags2KHR, dstBuffer: VkBuffer, dstOffset: VkDeviceSize, marker: u32) void;
...
pub const struct_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR = extern struct {
    sType: VkStructureType,
    pNext: ?*c_void,
    shaderZeroInitializeWorkgroupMemory: VkBool32,
};
pub const VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR = struct_VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR;
...
pub const VK_DEBUG_REPORT_OBJECT_TYPE_CU_MODULE_NVX_EXT = @enumToInt(enum_VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_CU_MODULE_NVX_EXT);
pub const VK_DEBUG_REPORT_OBJECT_TYPE_CU_FUNCTION_NVX_EXT = @enumToInt(enum_VkDebugReportObjectTypeEXT.VK_DEBUG_REPORT_OBJECT_TYPE_CU_FUNCTION_NVX_EXT);
...
pub const struct_VkCuLaunchInfoNVX = extern struct {
    ...
    sharedMemBytes: u32,
    paramCount: usize,
    pParams: [*c]const ?*const c_void,
    extraCount: usize,
    pExtras: [*c]const ?*const c_void,
};
...
pub const VkAabbPositionsNV = VkAabbPositionsKHR; // /usr/include/vulkan/vulkan_core.h:10219:35: warning: struct demoted to opaque type - has bitfield
...
pub const enum_VkProvokingVertexModeEXT = extern enum(c_int) {
    VK_PROVOKING_VERTEX_MODE_FIRST_VERTEX_EXT = 0,
    VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT = 1,
    VK_PROVOKING_VERTEX_MODE_MAX_ENUM_EXT = 2147483647,
    _,
};
pub const VK_PROVOKING_VERTEX_MODE_FIRST_VERTEX_EXT = @enumToInt(enum_VkProvokingVertexModeEXT.VK_PROVOKING_VERTEX_MODE_FIRST_VERTEX_EXT);
pub const VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT = @enumToInt(enum_VkProvokingVertexModeEXT.VK_PROVOKING_VERTEX_MODE_LAST_VERTEX_EXT);
pub const VK_PROVOKING_VERTEX_MODE_MAX_ENUM_EXT = @enumToInt(enum_VkProvokingVertexModeEXT.VK_PROVOKING_VERTEX_MODE_MAX_ENUM_EXT);
...
pub const offsetof = @compileError("TODO implement function '__builtin_offsetof' in std.c.builtins"); // /usr/lib/zig/include/stddef.h:104:9
...
pub const VK_DEFINE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /usr/include/vulkan/vulkan_core.h:25:9
pub const VK_DEFINE_NON_DISPATCHABLE_HANDLE = @compileError("unable to translate C expr: unexpected token .Keyword_typedef"); // /usr/include/vulkan/vulkan_core.h:55:17
...
pub const VK_NULL_HANDLE = @import("std").meta.cast(?*c_void, @as(c_int, 0));
pub inline fn VK_MAKE_VERSION(major: anytype, minor: anytype, patch: anytype) @TypeOf(((@import("std").meta.cast(u32, major) << @as(c_int, 22)) | (@import("std").meta.cast(u32, minor) << @as(c_int, 12))) | @import("std").meta.cast(u32, patch)) {
    return ((@import("std").meta.cast(u32, major) << @as(c_int, 22)) | (@import("std").meta.cast(u32, minor) << @as(c_int, 12))) | @import("std").meta.cast(u32, patch);
}
pub inline fn VK_MAKE_API_VERSION(variant: anytype, major: anytype, minor: anytype, patch: anytype) @TypeOf((((@import("std").meta.cast(u32, variant) << @as(c_int, 29)) | (@import("std").meta.cast(u32, major) << @as(c_int, 22))) | (@import("std").meta.cast(u32, minor) << @as(c_int, 12))) | @import("std").meta.cast(u32, patch)) {
    return (((@import("std").meta.cast(u32, variant) << @as(c_int, 29)) | (@import("std").meta.cast(u32, major) << @as(c_int, 22))) | (@import("std").meta.cast(u32, minor) << @as(c_int, 12))) | @import("std").meta.cast(u32, patch);
}
pub const VK_API_VERSION_1_0 = VK_MAKE_API_VERSION(@as(c_int, 0), @as(c_int, 1), @as(c_int, 0), @as(c_int, 0));
pub const VK_HEADER_VERSION = @as(c_int, 179);
pub const VK_HEADER_VERSION_COMPLETE = VK_MAKE_API_VERSION(@as(c_int, 0), @as(c_int, 1), @as(c_int, 2), VK_HEADER_VERSION);
pub inline fn VK_VERSION_MAJOR(version: anytype) @TypeOf(@import("std").meta.cast(u32, version) >> @as(c_int, 22)) {
    return @import("std").meta.cast(u32, version) >> @as(c_int, 22);
}
pub inline fn VK_VERSION_MINOR(version: anytype) @TypeOf((@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF)) {
    return (@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF);
}
pub inline fn VK_VERSION_PATCH(version: anytype) @TypeOf(@import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF)) {
    return @import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF);
}
pub inline fn VK_API_VERSION_VARIANT(version: anytype) @TypeOf(@import("std").meta.cast(u32, version) >> @as(c_int, 29)) {
    return @import("std").meta.cast(u32, version) >> @as(c_int, 29);
}
pub inline fn VK_API_VERSION_MAJOR(version: anytype) @TypeOf((@import("std").meta.cast(u32, version) >> @as(c_int, 22)) & @as(c_uint, 0x7F)) {
    return (@import("std").meta.cast(u32, version) >> @as(c_int, 22)) & @as(c_uint, 0x7F);
}
pub inline fn VK_API_VERSION_MINOR(version: anytype) @TypeOf((@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF)) {
    return (@import("std").meta.cast(u32, version) >> @as(c_int, 12)) & @as(c_uint, 0x3FF);
}
pub inline fn VK_API_VERSION_PATCH(version: anytype) @TypeOf(@import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF)) {
    return @import("std").meta.cast(u32, version) & @as(c_uint, 0xFFF);
}
...
pub const VK_KHR_MAINTENANCE1_SPEC_VERSION = @as(c_int, 2);
...
pub const VK_KHR_MAINTENANCE2_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_KHR_MAINTENANCE3_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_KHR_FRAGMENT_SHADING_RATE_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_NV_VIEWPORT_ARRAY2_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_EXT_IMAGE_DRM_FORMAT_MODIFIER_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_EXT_FRAGMENT_DENSITY_MAP_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_GOOGLE_HLSL_FUNCTIONALITY1_SPEC_VERSION = @as(c_int, 1);
...
pub const VK_EXT_VALIDATION_FEATURES_SPEC_VERSION = @as(c_int, 4);
...
pub const VK_KHR_ACCELERATION_STRUCTURE_SPEC_VERSION = @as(c_int, 11);
